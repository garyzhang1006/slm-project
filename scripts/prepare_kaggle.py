...
def prepare(output: Path, owner: str, slug: str, runner: str) -> None:
    ...
    efficient = runner in {"kaggle_efficient_run.py", "kaggle_efficiency_verify.py", "kaggle_short_qa_pilot.py"}
    ...
    (output / "kernel-metadata.json").write_text(json.dumps({
        ...
        "kernel_sources": (["garyzhang11111/slm-500m-efficient-continuation"]
                           if runner in {"kaggle_simple_questions_audit.py", "kaggle_short_qa_pilot.py"} else ["garyzhang11111/slm-500m-long-training"]
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--runner",
        choices=("kaggle_run.py", "kaggle_quality_run.py", "kaggle_500m_quality_run.py", "kaggle_studio_verify.py", "kaggle_english_run.py", "kaggle_qa_run.py", "kaggle_long_run.py", "kaggle_efficient_run.py", "kaggle_efficiency_verify.py", "kaggle_simple_questions_audit.py", "kaggle_short_qa_pilot.py"),
